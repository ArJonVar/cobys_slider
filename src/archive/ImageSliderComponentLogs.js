    ...
    useEffect(() => {
      ...
      if (filteredProjects.length === 0) {
        ...
        if (firstProjectWithPhotosIndex === -1) {
          ...
          console.log("4")
          // console.log('5', filteredProjects[currentProjectIndex]?.property === undefined )
      ...
      console.log("9", filteredProjects, currentProjectIndexTransition, filteredProjects[currentProjectIndexTransition])
